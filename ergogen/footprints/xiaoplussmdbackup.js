...
fp.push(`(footprint "xiao_plus_smd_ergogen"`);
fp.push(p.at);
...
// F.SilkS
fp.push(`(fp_rect (start ${(flip ? 8.89 : -8.89)} -10.5675) (end ${(flip ? -8.89 : 8.89)} 10.5675) (stroke (width 0.15) (type solid)) (fill no) (layer ${(flip ? "B.SilkS" : "F.SilkS")}))`);
...
fp.push(`(fp_rect (start ${(flip ? 1.50392 : -1.50392)} 4.0202) (end ${(flip ? 0.48792 : -0.48792)} 6.0522) (stroke (width 0) (type solid)) (fill yes) (layer "Dwgs.User"))`);
fp.push(`(fp_rect (start ${(flip ? -0.49608 : 0.49608)} 4.0202) (end ${(flip ? -1.51208 : 1.51208)} 6.0522) (stroke (width 0) (type solid)) (fill yes) (layer "Dwgs.User"))`);
fp.push(`(fp_circle (center -1.27 -8.5725) (end ${(flip ? 0.6985 : -0.6985)} -8.5725) (stroke (width 0) (type solid)) (fill yes) (layer "Dwgs.User"))`);
fp.push(`(fp_circle (center -1.27 -6.0325) (end ${(flip ? 0.6985 : -0.6985)} -6.0325) (stroke (width 0) (type solid)) (fill yes) (layer "Dwgs.User"))`);
fp.push(`(fp_circle (center 1.27 -8.5725) (end ${(flip ? -1.8415 : 1.8415)} -8.5725) (stroke (width 0) (type solid)) (fill yes) (layer "Dwgs.User"))`);
fp.push(`(fp_circle (center 1.27 -6.0325) (end ${(flip ? -1.8415 : 1.8415)} -6.0325) (stroke (width 0) (type solid)) (fill yes) (layer "Dwgs.User"))`);

// Edge.Cuts
fp.push(`(fp_rect (start ${(flip ? 5.73792 : -5.73792)} 4.2702) (end ${(flip ? 0.73792 : -0.73792)} 9.2702) (stroke (width 0.15) (type solid)) (fill no) (layer "Edge.Cuts"))`);
fp.push(`(fp_rect (start ${(flip ? 1.625 : -1.625)} -8.9275) (end ${(flip ? -1.625 : 1.625)} -5.6775) (stroke (width 0.15) (type solid)) (fill no) (layer "Edge.Cuts"))`);
