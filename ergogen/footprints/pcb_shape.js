...
// Edge.Cuts
fp.push(`(fp_line (start ${(flip ? 12.575 : -12.575)} -8.949998) (end ${(flip ? 12.575 : -12.575)} 64.911298) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
...
fp.push(`(fp_line (start ${(flip ? 11.324999 : -11.324999)} -10.2) (end ${(flip ? -206.6232 : 206.6232)} -10.2) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
...
fp.push(`(fp_line (start ${(flip ? -207.873199 : 207.873199)} -8.95) (end ${(flip ? -207.873199 : 207.873199)} 64.9113) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
fp.push(`(fp_line (start ${(flip ? -207.8732 : 207.8732)} -8.95) (end ${(flip ? -207.873199 : 207.873199)} -8.95) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
fp.push(`(fp_arc (start -11.324998 -8.949998) (end ${(flip ? 12.575 : -12.575)} -8.949998) (angle 89.9999) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
fp.push(`(fp_arc (start -11.324999 64.911299) (end ${(flip ? 11.326101 : -11.326101)} 66.161299) (angle 89.9495) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
fp.push(`(fp_arc (start 97.6491 27.5619) (end ${(flip ? -107.105152 : 107.105152)} 78.580248) (angle 21.0007) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
fp.push(`(fp_arc (start 206.6232 -8.95) (end ${(flip ? -206.6232 : 206.6232)} -10.2) (angle 90) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
fp.push(`(fp_arc (start 206.6232 64.9113) (end ${(flip ? -207.873199 : 207.873199)} 64.9113) (angle 89.9443) (stroke (width 0.15) (type default)) (layer "Edge.Cuts"))`);
