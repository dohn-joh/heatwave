...
module.exports = {
  ...
  (footprint "ceoloide:mcu_nice_nano"
    ...
    ${''/* USB socket outline */}
    (fp_line (start 3.683 -18.034) (end 3.683 -16.51) (layer "Dwgs.User") (stroke (width 0.15) (type solid)))
    (fp_line (start -3.683 -16.51) (end -3.683 -18.034) (layer "Dwgs.User") (stroke (width 0.15) (type solid)))
    (fp_line (start -3.683 -18.034) (end 3.683 -18.034) (layer "Dwgs.User") (stroke (width 0.15) (type solid)))
